...
const BackToTopButton: React.FC<BackToTopButtonProps> = ({
  ...
  const baseClasses =
    "fixed cursor-pointer bottom-5 p-1.5 px-4 lg:text-base text-sm rounded-full bg-primary text-neutral-900 hover:bg-primaryhover focus:outline-none z-50 font-medium"; // Base styles, removed hidden/sm:block
