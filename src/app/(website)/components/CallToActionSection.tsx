          ...
          <div className="bg-primary-foreground rounded-3xl p-8 md:p-12 lg:p-16 relative">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
              ...
              <div className="lg:w-2/3 text-center lg:text-left">
                <h2 className="text-4xl md:text-4xl lg:text-6xl font-bold mb-6 leading-tight text-mainheadingWhite">
                  Start your financial journey with{" "}
                  <span className="text-primary">Remityn today!</span>
                </h2>
                <p className="mt-6 text-zinc-300 text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
