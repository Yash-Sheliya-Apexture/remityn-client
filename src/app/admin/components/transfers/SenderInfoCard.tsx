...
//   // Handle null or undefined user case early
//   if (!user) {
//     return <p className="text-mainheadingWhite">Sender information not available.</p>;
//   }
...
//   return (
//     <div className="mb-8">
//       <h4 className="inline-flex items-center text-sky-500 bg-sky-500/15 text-sm font-semibold px-4 py-2 rounded-full mb-4 border border-sky-600/50">
//         <User className="size-4 mr-1.5 flex-shrink-0" />
//         Sender Information
//       </h4>
...
//       <div className="flex items-start sm:items-center rounded-xl border p-4 flex-col sm:flex-row">
//         {/* Avatar Container */}
//         <div className="relative w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center bg-sky-100 text-sky-700 flex-shrink-0 mb-3 sm:mb-0 overflow-hidden">
//           {user.profileImage ? (
//             <Image
//               src={user.profileImage}
//               alt={altText}
...
//             <Badge
//               variant="outline"
//               className="text-sky-500 border-sky-600/50 bg-sky-500/15 text-sm mt-1 sm:mt-0 flex-shrink-0 px-2 py-1"
//             >
//               Sender
//             </Badge>
//           </div>
//           <p className="text-subheadingWhite text-sm break-words">
//             {user.email || "Email not available"}
//           </p>
...
//             <div className="flex flex-wrap gap-x-6 gap-y-3">
//               <div className="flex items-center">
//                 <div className="w-8 h-8 rounded-full bg-secondarybox flex items-center justify-center mr-2 flex-shrink-0">
//                   <User className="w-4 h-4 text-white" />
//                 </div>
//                 <div>
//                   <p className="text-xs text-subheadingWhite">User ID</p>
//                   <p
//                     className="text-sm font-medium text-mainheadingWhite"
//                     title={user._id || ""}
//                   >
//                     {user._id ? `${user._id}` : "N/A"}
//                   </p>
...
//                 </div>
//                 <div>
//                   <p className="text-xs text-subheadingWhite">Member Since</p>
...
// Define a specific type for the user object, aligning with what might be passed
interface SenderUser {
  _id?: string | null;
  fullName?: string | null; // This could be derived from firstName/lastName in the parent
  email?: string | null;
  profileImage?: string | null;
  createdAt?: string | Date | null; // Allow string (ISO date) or Date object
}
...
const FallbackAvatar: React.FC<{ name: string | null | undefined }> = ({ name }) => (
  <span className="font-bold text-xl">
    {name ? name.charAt(0).toUpperCase() : "U"}
  </span>
);
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p
                    ...
                    title={user._id || ""}
                  >
                    {user._id ? `${user._id.substring(0, 8)}...` : "N/A"} {/* Truncate ID for display */}
                  </p>
                </div>
              </div>
