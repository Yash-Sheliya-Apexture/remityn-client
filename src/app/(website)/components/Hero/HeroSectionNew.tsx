...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative text-white flex pt-24 pb-10 px-4 overflow-hidden -mt-28">
      ...
      {/* Central Nebula Glow */}
      {/* <div
        className="absolute inset-0 m-auto w-[100vw] h-[100vh] max-w-[1400px] max-h-[1400px] opacity-30"
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(170, 70, 220, 0.50) 0%, transparent 60%)",
          pointerEvents: "none",
          transform: "scale(1.3)",
        }}
      /> */}
