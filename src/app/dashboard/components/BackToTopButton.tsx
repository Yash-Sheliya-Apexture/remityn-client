...
const BackToTopButton: React.FC<BackToTopButtonProps> = ({
  ...
  const baseClasses =
    "fixed cursor-pointer bottom-2 p-1.5 px-4 lg:text-base text-sm rounded-full bg-primary text-mainheading hover:bg-primaryhover focus:outline-none z-30 font-medium"; // Base styles, removed hidden/sm:block
